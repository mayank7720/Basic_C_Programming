/* Extracted commented content from: arrays/arrayassingment.c */
...
/* --- CODE comment starting at line 41 (line) --- */
...
/* --- CODE comment starting at line 73 (line) --- */
printf("\nZeroes: ");
for(i=0;i<n;i++) if(a[i]==0) printf("%d ",a[i]);
}
...
/* --- CODE comment starting at line 84 (line) --- */
for(i=n-1;i>=0;i--) printf("%d ", a[i]);
}

/* --- CODE comment starting at line 87 (line) --- */
Sum of 10 integer
#include <stdio.h>
int main(){
int i, x, sum=0;
...
/* --- CODE comment starting at line 98 (line) --- */
...
/* --- CODE comment starting at line 110 (line) --- */
Sum of even no
#include <stdio.h>
int main(){
int a[50], n, i, sum=0;
...
/* --- CODE comment starting at line 122 (line) --- */
Print odd no
#include <stdio.h>
int main(){
int a[50], n, i;
...
/* --- CODE comment starting at line 143 (line) --- */
Search Number
#include <stdio.h>
int main(){
...
/* --- CODE comment starting at line 156 (line) --- */
Sort Assending
#include <stdio.h>
int main(){
int a[50], n, i, j, t;
...
/* --- CODE comment starting at line 171 (line) --- */
Count Occurrence
#include <stdio.h>
int main(){
...
/* --- CODE comment starting at line 182 (line) --- */
...
/* --- CODE comment starting at line 198 (line) --- */
Sort Descending
#include <stdio.h>
int main(){
int a[50], n, i, j, t;
...
/* --- CODE comment starting at line 212 (line) --- */
...
/* --- CODE comment starting at line 224 (line) --- */
Print 2D array
#include <stdio.h>
int main(){
int a[10][10], r, c, i, j;
...
/* --- CODE comment starting at line 233 (line) --- */
for(i=0;i<r;i++){
for(j=0;j<c;j++)
printf("%d ",a[i][j]);
printf("\n");
...
/* --- CODE comment starting at line 240 (line) --- */
...
/* --- CODE comment starting at line 253 (line) --- */
Sum of two matrix
#include <stdio.h>
int main(){
...
/* --- CODE comment starting at line 263 (line) --- */
for(i=0;i<r;i++)
for(j=0;j<c;j++)
scanf("%d",&b[i][j]);

/* --- CODE comment starting at line 267 (line) --- */
for(i=0;i<r;i++)
for(j=0;j<c;j++)
s[i][j]=a[i][j]+b[i][j];

/* --- CODE comment starting at line 271 (line) --- */
for(i=0;i<r;i++){
...
/* --- CODE comment starting at line 277 (line) --- */
Sum of all elements
#include <stdio.h>
int main(){
...
/* --- CODE comment starting at line 290 (line) --- */
...
/* --- CODE comment starting at line 303 (line) --- */
Transpose
#include <stdio.h>
int main(){
...
/* --- CODE comment starting at line 312 (line) --- */
for(i=0;i<r;i++)
for(j=0;j<c;j++)
t[j][i]=a[i][j];

/* --- CODE comment starting at line 316 (line) --- */
for(i=0;i<c;i++){
...
/* --- CODE comment starting at line 322 (line) --- */
...
/* --- CODE comment starting at line 329 (line) --- */
for(i=0;i<n;i++)
for(j=0;j<n;j++)
scanf("%d",&a[i][j]);

/* --- CODE comment starting at line 333 (line) --- */
for(j=0;j<n;j++) sum+=a[mid][j];
for(i=0;i<n;i++) sum+=a[i][mid];

/* --- CODE comment starting at line 336 (line) --- */
sum -= a[mid][mid];
printf("%d", sum);
}

/* --- CODE comment starting at line 340 (line) --- */
Product of matrices
#include <stdio.h>
int main(){
...
/* --- CODE comment starting at line 346 (line) --- */
scanf("%d%d",&r1,&c1);
for(i=0;i<r1;i++) for(j=0;j<c1;j++) scanf("%d",&a[i][j]);

/* --- CODE comment starting at line 349 (line) --- */
scanf("%d%d",&r2,&c2);
for(i=0;i<r2;i++) for(j=0;j<c2;j++) scanf("%d",&b[i][j]);

/* --- CODE comment starting at line 352 (line) --- */
if(c1!=r2){ printf("Not possible"); return 0; }

/* --- CODE comment starting at line 354 (line) --- */
for(i=0;i<r1;i++)
for(j=0;j<c2;j++)
for(k=0;k<c1;k++)
p[i][j] += a[i][k] * b[k][j];

/* --- CODE comment starting at line 359 (line) --- */
for(i=0;i<r1;i++){
...
/* --- CODE comment starting at line 365 (line) --- */
...
/* --- CODE comment starting at line 371 (line) --- */
for(i=0;i<r;i++) for(j=0;j<c;j++) scanf("%d",&a[i][j]);
for(i=0;i<r;i++) for(j=0;j<c;j++) scanf("%d",&b[i][j]);

/* --- CODE comment starting at line 374 (line) --- */
for(i=0;i<r;i++)
for(j=0;j<c;j++)
d[i][j]=a[i][j]-b[i][j];

/* --- CODE comment starting at line 378 (line) --- */
for(i=0;i<r;i++){
...
/* --- CODE comment starting at line 385 (line) --- */
...
/* --- NOTE comment starting at line 398 (line) --- */
